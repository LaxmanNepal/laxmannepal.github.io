...
async function inject(response){
 ...
 try{
  ...
  const styles=['mobile-parity.css?v=14'];
  ...
  const scripts=['launcher-enhancements.js?v=14','launcher-next.js?v=14','launcher-cards.js?v=14','launcher-identity.js?v=14','launcher-metadata.js?v=14','launcher-details.js?v=14','interactive-clean.js?v=14','quick-look.js?v=14','catalog-fallback.js?v=14'];
