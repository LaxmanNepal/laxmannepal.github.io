...
async function inject(response){
 ...
 try{
  ...
  const styles=['mobile-parity.css?v=12'];
  ...
  const scripts=['launcher-enhancements.js?v=12','launcher-next.js?v=12','launcher-cards.js?v=12','launcher-identity.js?v=12','launcher-metadata.js?v=12','launcher-details.js?v=12','interactive-clean.js?v=12','quick-look.js?v=12','catalog-fallback.js?v=12'];
