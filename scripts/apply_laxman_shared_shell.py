...
<a class="shared-brand" href="/" aria-label="Laxman Nepal home"><span class="shared-logo">LN</span><span><strong>Laxman Nepal</strong><small>Tools · AI · Blog · YouTube</small></span></a>
<nav class="shared-desktop-nav" aria-label="Main menu">
<a href="/">Home</a><a href="/tools/">Tools</a><a href="/ai-tools/">AI Tools</a><a href="/blog/">Blog</a><a href="/youtube-tools/">YouTube</a>
<details class="nav-dropdown"><summary>Explore</summary><div class="nav-dropdown-menu"><a href="/news/">News & Updates</a><a href="/guides/">Guides</a><a href="/mobile/">Mobile</a><a href="/apps/">Apps</a><a href="/contact/">Contact</a></div></details>
</nav>
...
FOOTER = r'''<footer class="shared-footer" data-shared-shell="footer"><div class="shared-footer-grid"><div><div class="shared-footer-brand"><span class="shared-logo">LN</span><strong>Laxman Nepal</strong></div><p>Practical tools, AI resources, tutorials and useful digital guides built by Laxman Nepal.</p></div><div><strong>Tools</strong><a href="/tools/">All Tools</a><a href="/ai-tools/">AI Tools</a><a href="/apps/">Apps</a><a href="/youtube-tools/">YouTube Tools</a><a href="/search/">Search</a></div><div><strong>Content</strong><a href="/blog/">Blog</a><a href="/news/">News</a><a href="/guides/">Guides</a><a href="/about/">About</a></div><div><strong>Connect</strong><a href="https://www.youtube.com/@laxmannepalofficial">YouTube</a><a href="https://www.instagram.com/laxmannepalsir/">Instagram</a><a href="https://github.com/LaxmanNepal">GitHub</a><a href="/contact/">Contact</a></div></div><div class="shared-footer-bottom"><span>© <span id="year"></span> Laxman Nepal · All rights reserved</span><span>Built for usefulness.</span></div></footer>'''

SCRIPT = r'''<script data-shared-shell-script="laxman">(()=>{const h=document.querySelector('[data-shared-shell="header"]');if(h){h.style.setProperty('position','fixed','important');h.style.setProperty('top','10px','important');h.style.setProperty('z-index','2147483000','important');h.style.setProperty('width','min(calc(100% - 24px),1240px)','important');h.style.setProperty('left','50%','important');h.style.setProperty('right','auto','important');h.style.setProperty('transform','translate3d(-50%,0,0)','important');if(h.parentElement!==document.documentElement)document.documentElement.appendChild(h);window.addEventListener('resize',()=>{if(innerWidth<=900){h.style.setProperty('left','12px','important');h.style.setProperty('right','12px','important');h.style.setProperty('width','auto','important');h.style.setProperty('transform','none','important')}else{h.style.setProperty('left','50%','important');h.style.setProperty('right','auto','important');h.style.setProperty('width','min(calc(100% - 24px),1240px)','important');h.style.setProperty('transform','translate3d(-50%,0,0)','important')}})}const m=document.querySelector('[data-shared-menu]'),n=document.querySelector('[data-shared-mobile]'),c=document.querySelector('[data-shared-close]'),b=document.querySelector('[data-shared-backdrop]');const hide=()=>{n?.classList.remove('open');if(b)b.style.display='none';document.body.style.overflow=''};m?.addEventListener('click',()=>{n?.classList.add('open');if(b)b.style.display='block';document.body.style.overflow='hidden'});c?.addEventListener('click',hide);b?.addEventListener('click',hide);n?.querySelectorAll('a').forEach(a=>a.addEventListener('click',hide));document.addEventListener('keydown',e=>{if(e.key==='Escape')hide()});const y=document.getElementById('year');if(y)y.textContent=new Date().getFullYear()})();</script>'''
